...
export const OrderPants = () => {
  ...
  //     const s1 = getValues('pants-selectPattern1');
  //     const s2 = getValues('pants-selectPattern2');
  //     if (!s1 || !s2) return;
  //     // console.log('s1', s1);
  //     // console.log('s2', s2);
  ...
  //   setValue('pants-selectPattern2', 'empty');
  //   setValue('pants-selectPattern3', 'empty');
  ...
  return (
    <>
      <div className="font-bold text-blue-600">OrderPants</div>
      <div>発注_パンツ _ID：{getValues('pants-pantsOrderId')}</div>
      <RhfSelect
        label="セレクトパターン1"
      ...
      <RhfSelect
        ...
        menuItems={[
          ...
          { value: 'ループ０本アジャスタ有', label: 'ループ０本アジャスタ有' },
