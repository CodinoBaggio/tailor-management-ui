...
export const OrderJaket = () => {
  ...
  //     const s1 = getValues('jaket-selectPattern1');
  //     const s2 = getValues('jaket-selectPattern2');
  //     if (!s1 || !s2) return;
  //     // console.log('s1', s1);
  //     // console.log('s2', s2);
  ...
  //   setValue('jaket-selectPattern2', 'empty');
  //   setValue('jaket-selectPattern3', 'empty');
  ...
  return (
    <>
      ...
      <div>発注_上着_ID：{getValues('jaket-jaketOrderId')}</div>
      <RhfSelect
        label="セレクトパターン1"
